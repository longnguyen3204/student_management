                    ...
                    <div class="card-body">
                        <form action="" method="post"> <!-- add user form  -->
                            ...
                            <div class="form-group">
                                <button type="submit" name="btn_add_student" class="btn btn-primary">Thêm sinh viên</button> <!-- add new user button -->
                                <button type="button" name="btn_cancel"  class="btn btn-secondary" onclick="window.location.href='student-manage-code.php'">Hủy</button> 
                            </div>
                        </form>
                    </div>
                </div>
