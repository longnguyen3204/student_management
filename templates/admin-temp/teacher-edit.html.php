                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="" method="post"> <!-- user edit form -->
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" name="btn_edit_teacher"  class="btn btn-primary">Cập nhật</button> <!-- edit button -->
                                <button type="button" name="btn_cancel"  class="btn btn-secondary" onclick="window.location.href='teacher-manage-code.php'">Hủy</button> <!-- cancel link to user manage page -->
                            </div>
                        </form>
                    </div>
                </div>
