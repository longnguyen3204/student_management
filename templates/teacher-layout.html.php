...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li><a href="<?=$BASE_URL?>/controllers/teacher/noti-manage-code.php">Quản lý thông báo</a></li>
            <li><a href="<?=$BASE_URL?>/controllers/teacher/grade-manage-code.php">Quản lý điểm</a></li>
